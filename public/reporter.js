...
var _Reporter = __webpack_require__(4);
...
function renderReport(duplicates) {
  app = (0, _preact.render)((0, _preact.h)(_Reporter2.default, { data: duplicates }), document.getElementById('reporterApp'), app);
}
...
var _preactMdl = __webpack_require__(1);
...
class Reporter extends _preact.Component {
  constructor(...args) {
    super(...args);
  }
